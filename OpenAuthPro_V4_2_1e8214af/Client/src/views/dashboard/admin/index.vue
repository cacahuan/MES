  ...
  <div class="dashboard-editor-container">
    ...
    <el-row class="auth-box" :gutter="0">
      ...
      <el-col :span="6" v-for="good in goods" :key="good.type" class="auth-col" :class="{'active': good.recomment}">
        <div class="auth-head">
          <a target="_blank" href="http://openauth.net.cn/question/detail.html?id=a2be2d61-7fcb-4df8-8be2-9f296c22a89c">
    ...
    data() {
      return {
        auths: [{
          ...
          belongs: ['base','senior','business'],
          baseRemark: '社区VIP1标识',
          seniorRemark: '社区VIP2标识',
          businessRemark: '社区VIP2标识'
        },{
          name: '专属授权文件',
          belongs: ['base','senior','business']
        },{
          ...
          name: '技术咨询服务',
          belongs: ['senior', 'business'],
          seniorRemark: '为个人提供技术咨询服务',
          businessRemark: '为公司开发团队提供技术咨询服务'
        },{
          name: '拥有独立的知识产权',
          belongs: ['business']
        },{
